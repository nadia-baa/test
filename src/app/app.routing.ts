    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'pages', children: [
                ...
                //gerer le users
                {path: 'gerer', children: [
                    {path: 'add-user', loadChildren: () => import('app/modules/admin/pages/manage-users/add-user/add-user.module').then(m => m.AddUserModule)},
                    {path: 'users', loadChildren: () => import('app/modules/admin/pages/manage-users/existing-users/users.module').then(m => m.UsersModule)},
                    {path: 'users/edit/:id', loadChildren: () => import('app/modules/admin/pages/manage-users/edit-user/edit-user.module').then(m => m.EditUserModule)},
                    {path: 'users/preview/:id', loadChildren: () => import('app/modules/admin/pages/manage-users/user/user.module').then(m => m.UserModule)} 
                ]},
